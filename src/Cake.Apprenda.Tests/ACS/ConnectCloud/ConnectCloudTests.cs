...
{
    public sealed class ConnectCloudTests : CloudShellCommandTestBase<Apprenda.ACS.ConnectCloud.ConnectCloud, ConnectCloudSettings, ConnectCloudFixture>
    {
        [Fact]
        ...
        [Fact]
        public void Should_Format_Arguments_Correctly_If_DevTeam_Alias_Is_Specified()
        {
            // Given
            var fixture = new ConnectCloudFixture();
            fixture.Settings.DevTeamAlias = "myDevTeam";

            // When
            var result = fixture.Run();

            // Then
            Assert.Equal("ConnectCloud --NonInteractive -CloudAlias myCloudAlias -User user@apprenda.com -Password p@ssword -DevTeamAlias myDevTeam", result.Args);
        }
    }
}
