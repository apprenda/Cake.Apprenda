...
namespace Cake.Apprenda.AMM.ReadRegisteredClouds
{
    /// <summary>
    /// Reads the clouds registered with AMM
    /// </summary>
    /// <seealso cref="MaintenanceModeTool{TSettings}" />
    public sealed class ReadRegisteredClouds : MaintenanceModeTool<ReadRegisteredCloudsSettings>
    {
        /// <summary>
        ...
        public ReadRegisteredClouds(IFileSystem fileSystem, ICakeEnvironment environment, IProcessRunner processRunner, IToolLocator tools, IMaintenanceModeToolResolver resolver)
        ...
        public IEnumerable<CloudInfo> Execute(ReadRegisteredCloudsSettings settings)
        {
            ...
            {
                result = this.ParseResults(process.GetStandardOutput());
            };
