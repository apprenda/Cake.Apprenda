...
namespace Cake.Apprenda.ACS.ConnectCloud
{
    ...
    public sealed class ConnectCloud : CloudShellTool<ConnectCloudSettings>
    {
        ...
        public ConnectCloud(IFileSystem fileSystem, ICakeEnvironment environment, IProcessRunner processRunner, IToolLocator tools, ICloudShellToolResolver resolver)
